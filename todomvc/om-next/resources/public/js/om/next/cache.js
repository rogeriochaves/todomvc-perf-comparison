...
var id_SINGLEQUOTE__11461 = self__.arr.shift();
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(self__.index,((function (id_SINGLEQUOTE__11461,this$){
return (function (p1__11460_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(p1__11460_SHARP_,id_SINGLEQUOTE__11461),id,x);
});})(id_SINGLEQUOTE__11461,this$))
);
} else {
...
om.next.cache.Cache.cljs$lang$ctorPrWriter = (function (this__6406__auto__,writer__6407__auto__,opt__6408__auto__){
return cljs.core._write(writer__6407__auto__,"om.next.cache/Cache");
});
...
return (new om.next.cache.Cache([],(function (){var G__11463 = cljs.core.PersistentArrayMap.EMPTY;
return (cljs.core.atom.cljs$core$IFn$_invoke$arity$1 ? cljs.core.atom.cljs$core$IFn$_invoke$arity$1(G__11463) : cljs.core.atom.call(null,G__11463));
})(),size));
});
